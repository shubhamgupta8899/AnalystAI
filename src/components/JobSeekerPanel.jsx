      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 animate-in fade-in slide-in-from-right-4 duration-500">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4 sm:mb-6">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg border border-green-200 dark:border-green-800 font-bold text-xl sm:text-2xl text-white">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-1 sm:gap-2 mt-1 sm:mt-2">
                  <span className="font-mono bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-2 py-1 rounded-md sm:rounded-lg text-xs font-medium">
                    Careers
                  </span>
                  <span className="hidden xs:inline text-gray-400">•</span>
                  <span className="flex items-center gap-1 text-xs sm:text-sm font-semibold px-2 sm:px-3 py-1 rounded-full bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            {/* Open Positions */}
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-4">
                {analysis.openPositions?.length > 0 ? (
                  ...
                  <div className="text-center py-6 sm:py-8 text-gray-500 dark:text-gray-400">
                    <Briefcase className="w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 opacity-50" />
                    <p className="text-sm sm:text-base">No open positions data available from LLM</p>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="space-y-4">
                {analysis.interviewProcess?.length > 0 ? (
                  ...
                  <div className="text-center py-4 text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-sm sm:text-base">No interview process data available</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-3 sm:space-y-4">
                {analysis.employeeReviews?.length > 0 ? (
                  ...
                  <div className="text-center py-4 text-gray-500 dark:text-gray-400">
                    <Star className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 opacity-50" />
                    <p className="text-sm sm:text-base">No review data available</p>
                  </div>
                )}
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <div className="relative inline-block mb-4 sm:mb-6">
            <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl sm:rounded-3xl flex items-center justify-center shadow-2xl mb-3 sm:mb-4 mx-auto">
              <Briefcase className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-white" />
            </div>
            <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 bg-yellow-500 rounded-full flex items-center justify-center animate-pulse shadow-lg">
              <Zap className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-white" />
            </div>
          </div>
          
          <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-6xl font-bold bg-gradient-to-br from-gray-900 to-green-600 dark:from-white dark:to-green-400 bg-clip-text text-transparent mb-3 sm:mb-4">
            Career Intelligence
          </h1>
        ...
        <div className="mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white text-center mb-6 sm:mb-8 lg:mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {quickActions.map((action, index) => (
              <div
                key={index}
                className="group cursor-pointer bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-2xl transition-all duration-300 hover:scale-105"
                onClick={() => onQuickStart && onQuickStart(action.title)}
              >
                <div className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br ${action.color} rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="mb-8 sm:mb-12 lg:mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8 gap-3 sm:gap-4">
            {popularCompanies.map((company, index) => (
              <div
                key={index}
                className="group cursor-pointer bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg sm:rounded-xl border border-gray-200 dark:border-gray-700 p-3 sm:p-4 shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105"
                onClick={() => onQuickStart && onQuickStart(company.name)}
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-green-400 to-emerald-500 rounded-md sm:rounded-lg flex items-center justify-center mb-2 sm:mb-3 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="text-center">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8 lg:p-12 shadow-sm">
            <Search className="w-12 h-12 sm:w-16 sm:h-16 text-green-500 mx-auto mb-4 sm:mb-6" />
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base lg:text-lg mb-4 sm:mb-6 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
              <button 
                ...
                className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-br from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center gap-2 sm:gap-3 text-sm sm:text-base"
              >
...
const LoadingState = () => (
  <div className="flex-1 flex items-center justify-center">
    <div className="text-center">
      <Loader2 className="w-12 h-12 sm:w-16 sm:h-16 text-green-500 animate-spin mx-auto mb-3 sm:mb-4" />
...
// Supporting Components with responsive updates
const JobCard = ({ job }) => (
  <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-lg sm:rounded-xl border border-gray-200 dark:border-gray-700 p-3 sm:p-4 hover:shadow-md transition-all duration-300 hover:border-green-300 dark:hover:border-green-600">
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3">
      <div className="flex-1">
        ...
        <div className="flex flex-wrap gap-1 sm:gap-2">
          {job.skills?.map((skill, index) => (
            <span key={index} className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs rounded-full">
              {skill}
            </span>
      ...
      <div className="flex sm:flex-col gap-2 sm:items-end mt-2 sm:mt-0">
        <span className="text-xs text-gray-500 dark:text-gray-400 whitespace-nowrap">
          {job.posted || "Recently"}
        </span>
        <button className="flex items-center gap-1 px-2 sm:px-3 py-1.5 sm:py-2 bg-green-500 hover:bg-green-600 text-white text-xs sm:text-sm font-medium rounded-lg transition-colors duration-200">
          Apply Now
...
const CultureItem = ({ text }) => (
  <li className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-600 dark:text-gray-300">
...
const ProcessStep = ({ step, title, duration, description }) => (
  <div className="flex items-start gap-3 sm:gap-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-100 dark:border-green-800">
    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center text-white text-xs sm:text-sm font-bold flex-shrink-0">
      {step}
    </div>
    <div className="flex-1">
  ...
  return (
    <div className="space-y-1 sm:space-y-2">
      <div className="flex justify-between items-center">
        ...
        <span className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white">{value}/5</span>
      </div>
...
const ReviewCard = ({ rating, comment, role, tenure }) => (
  <div className="bg-gray-50 dark:bg-gray-800/60 rounded-lg p-3 sm:p-4 border border-gray-200 dark:border-gray-700">
    ...
    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mb-1 sm:mb-2 italic">"{comment}"</p>
